                        ...
                        <form action="{{ route('product-update', $product->id)}}" method="POST" class="p-6 bg-white rounded shadow-md">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="product_name"
                                    name="product_name" value="{{ old('product_name', $product->product_name) }}" required class="w-full p-2 mt-2 border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500">
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="type" name="type"
                                    value="{{ old('type', $product->type) }}" required class="w-full p-2 mt-2 border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500">
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" id="qty" name="qty"
                                    value="{{ old('qty', $product->qty) }}" required class="w-full p-2 mt-2 border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500">
                            </div>
                            <div class="mb-6">
                                <label for="producer" class="block font-medium text-gray-700">Producer:</label>
                                <input type="text" id="producer"
                                    name="producer" value="{{ old('producer', $product->producer) }}"
                                    required class="w-full p-2 mt-2 border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500">
                            </div>

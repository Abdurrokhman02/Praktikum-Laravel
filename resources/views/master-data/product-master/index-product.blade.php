<x-app-layout>
    ...
    <div class="container p-4 mx-auto">
        <div class="overflow-x-auto">
            ...
            <button type="button" id="btnExportJPG" class="px-6 py-4 mb-4 text-white bg-green-500 border border-green-500 rounded-lg shadow-lg hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500">
                Export JPG
            </button>
            <div id="area-ekspor">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        btnExportJPG.addEventListener('click', function() {
            ...
            html2canvas(exportArea, {
                ...
                link.download = 'laporan-produk.jpg';
                link.click();

                btnExportJPG.disabled = false;
                btnExportJPG.innerText = 'Export JPG';
            }).catch(err => {
    ...
    // Fungsi konfirmasi hapus (pindahkan keluar dari DOMContentLoaded agar bisa dipanggil inline)
